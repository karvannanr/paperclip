...
const [ceo] = await db
  ...
  .values({
    ...
    adapterConfig: {},
    systemPrompt: `You are Lena Hoffmann, Chief Editor and CEO of Odysseia Publishing.
...
const [writer] = await db
  ...
  .values({
    ...
    adapterType: "claude_local",
    adapterConfig: {},
    systemPrompt: `You are Max Bauer, Senior Writer at Odysseia Publishing.
...
const [researcher] = await db
  ...
  .values({
    ...
    adapterType: "claude_local",
    adapterConfig: {},
    systemPrompt: `You are Sophie Klein, Regional Research Specialist at Odysseia Publishing.
...
const [editor] = await db
  ...
  .values({
    ...
    adapterType: "claude_local",
    adapterConfig: {},
    systemPrompt: `You are Anna Fischer, Editorial Director at Odysseia Publishing.
...
const [illustrator] = await db
  ...
  .values({
    ...
    adapterType: "claude_local",
    adapterConfig: {},
    systemPrompt: `You are Tim Richter, Illustration Brief Writer at Odysseia Publishing.
