...
```
gh api repos/stapler/stapler/security-advisories/{{ghsaId}}
...
```
gh api --method POST \
  repos/stapler/stapler/security-advisories/{{ghsaId}}/forks
...
```
gh api --method POST \
  repos/stapler/stapler/security-advisories/{{ghsaId}}/cve
...
```
gh api repos/stapler/stapler/security-advisories/{{ghsaId}} --jq '.credits'
...
```
gh api --method PATCH \
  repos/stapler/stapler/security-advisories/{{ghsaId}} \
  --input - << 'EOF'
{
  "credits": [
    {
...
### Advisory
https://github.com/googlarz/stapler/security/advisories/{{ghsaId}}
...
* The published advisory URL: `https://github.com/googlarz/stapler/security/advisories/{{ghsaId}}`
* The release URL
