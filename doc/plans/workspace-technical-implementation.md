...
This repo already uses `STAPLER_DEPLOYMENT_MODE` for auth/deployment behavior (`local_trusted | authenticated`).
...
- `STAPLER_EXECUTION_TOPOLOGY=local|cloud|hybrid`
...
- use `STAPLER_EXECUTION_TOPOLOGY` as a defaulting guardrail
